$(document).ready(function () {
  $(".m1").click(function () {
    window.open("acebed.html");
  });
  $(".m2").click(function () {
    window.open("eoyeomo.html");
  });
  $(".m3").click(function () {
    window.open("roundaround.html");
  });
  $(".m4").click(function () {
    window.open("kumkang.html");
  });
  $(".m5").click(function () {
    window.open("vuetodo.html");
  });
  $(".m6").click(function () {
    window.open("acebed.html");
  });
  ...
  $(".vuetodo").click(function () {
    window.location.href = "https://github.com/shinyluck12/vue-todo";
  });
  $(".s_email").click(function () {
    window.location.href = "mailto:vampireapire@naver.com";
  });
  $("#top").click(function () {
